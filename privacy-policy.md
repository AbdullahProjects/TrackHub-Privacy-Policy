...
This Privacy Notice for **TrackHub** ("**we**," "**us**," or "**our**") describes how and why we might access, collect, store, use, and/or share ("**process**") your personal information when you use our services ("**Services**"), including when you:

- Download and use our mobile application (TrackHub), or any other application of ours that links to this Privacy Notice
- Use TrackHub — a real-time transport tracking application
...
- *Location Data.* We collect location data such as information about your device's location, which can be either precise or imprecise. We may use GPS and other technologies to collect geolocation data that tells us your current location. You can opt out of allowing us to collect this information either by refusing access or by disabling your Location setting on your device. However, if you choose to opt out, you may not be able to use certain aspects of the Services.
...
If you have questions or comments about this notice, you may email us at [abdullah.k.kakar@gmail.com](mailto:abdullah.k.kakar@gmail.com) or contact us by post at:
